...
//
  ...
  #define BED_CHECK_INTERVAL 1   // (ms) Interval between checks in bang-bang control
...
//
  ...
  #define CHAMBER_CHECK_INTERVAL 1   // (ms) Interval between checks in bang-bang control
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PB8          // Set a custom pin for the controller fan
...
#define HOMING_BUMP_MM      { 2, 2, 2, 2, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 10, 10, 10, 2, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 1, 1, 1, 0, 0 }  // (mm) Backoff from endstops after homing
...
#define LIN_ADVANCE 1
  ...
  #define LIN_ADVANCE_K 0.005    // Unit: mm compression per 1mm/s extruder speed
