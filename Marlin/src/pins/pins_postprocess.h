...
#undef _STOP_IN_USE
  ...
  #undef Y2_MIN_PIN
#endif
#if ((DISABLED(Y_DUAL_ENDSTOPS) || Y_HOME_TO_MIN) && (DISABLED(Y_DUAL_EITHER_ENDSTOPS) && (ANOTHER_Y_ENDSTOP_PIN == Y2_MAX_PIN)))
  #undef Y2_MAX_PIN
#endif
#if DISABLED(Z_MULTI_ENDSTOPS) || Z_HOME_TO_MAX
  #undef Z2_MIN_PIN
#endif
#if ((DISABLED(Z_MULTI_ENDSTOPS) || Z_HOME_TO_MIN) && (DISABLED(Z_DUAL_EITHER_ENDSTOPS) && (ANOTHER_Z_ENDSTOP_PIN == Z2_MAX_PIN)))
  #undef Z2_MAX_PIN
#endif
