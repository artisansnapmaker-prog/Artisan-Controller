...
#define SACP_TIMEOUT_DEFAULT  (2000)
#define SACP_RETRY_DEFAULT    (2)
...
#define SACP_CMD_ID_GLOABL_NOTIFY_START_REBOOT      (0x04)
#define SACP_CMD_ID_GLOABL_REQ_UNSUBSCRIPT_BY_PEER  (0x07)


#define SSTP_ESP32_UPDATE_FW_EVENT_ASK        (0x10)

#define SACP_CMD_ID_GLOABL_REQ_SET_PC_PROTOCOL  (0x11)
#define SACP_CMD_ID_GLOABL_REQ_FACTORY_RESET    (0x13)
...
#define SACP_CMD_ID_GLOABL_REQ_GET_BOARD_TEMP   (0x23)
...
#define SACP_CMD_ID_GLOABL_NOTIFY_MOVE_ABSOLUTELY     (0x33)
...
#define SACP_CMD_ID_WORKING_FLOW_SUB_FEEDRATE            (0xa2)
#define SACP_CMD_ID_WORKING_FLOW_SUB_FEEDRATE_PERCENTAGE (0xa4)
#define SACP_CMD_ID_WORKING_FLOW_SUB_JOB_PRINT_TIME      (0xa5)
