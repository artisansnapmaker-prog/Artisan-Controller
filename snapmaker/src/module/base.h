...
enum ModuleDeviceID {
  ...
  MODULE_DEVICE_ID_J1_CONTROLLER = 2049,
  MODULE_DEVICE_ID_A400_CONTROLLER = 2050,

  // other bus independent modules
  MODULE_DEVICE_ID_ESP32_NO_PARSM_OV2640 = 2560,
  MODULE_DEVICE_ID_ESP32_PARSM_OV2640,
...
enum ModuleFunctionID {
  ...
  MODULE_FUNC_REPORT_LASER_WEAK_POWER     ,  // 71
  MODULE_FUNC_SET_LASER_WEAK_POWER        ,  // 72
  MODULE_FUNC_SET_GET_PROTECT_TEMP    = 73,  // 73 
  MODULE_FUNC_GET_LASER_HOUSING_TEMP = 1000,  // 1000
  MODULE_FUNC_SET_TEC_TEMP           = 1001,  // 1001
  MODULE_FUNC_MAX
};
