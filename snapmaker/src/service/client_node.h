...
#define SACP_RET_JOB_RECOVER_ENV_FAILED               (SACP_RET_PRIVATE_BASE + 15)
#define SACP_RET_JOB_UNMATCHED_TOOLHEAD               (SACP_RET_PRIVATE_BASE + 16)
#define SACP_RET_JOB_STANDBY_FAILED                   (SACP_RET_PRIVATE_BASE + 17)
#define SACP_RET_JOB_NO_TOOLHEAD                      (SACP_RET_PRIVATE_BASE + 18)
#define SACP_RET_JOB_TOOLHEAD_OFFLINE                 (SACP_RET_PRIVATE_BASE + 19)
#define SACP_RET_JOB_EXCEPTION_BAN                    (SACP_RET_PRIVATE_BASE + 20)
#define SACP_RET_JOB_FDM_EXTRUDER_STATE               (SACP_RET_PRIVATE_BASE + 21)
#define SACP_RET_JOB_FDM_NOZZLE_TYPE                  (SACP_RET_PRIVATE_BASE + 22)
#define SACP_RET_JOB_FDM_NOZZLE_TEMP                  (SACP_RET_PRIVATE_BASE + 23)
#define SACP_RET_JOB_FDM_FILAMENT_RUNOUT              (SACP_RET_PRIVATE_BASE + 24)
#define SACP_RET_JOB_CNC_OVERCURRENT                  (SACP_RET_PRIVATE_BASE + 25)
#define SACP_RET_JOB_CNC_P_TEMP_EXCE                  (SACP_RET_PRIVATE_BASE + 26)
#define SACP_RET_JOB_CNC_M_TEMP_EXCE                  (SACP_RET_PRIVATE_BASE + 27)
#define SACP_RET_JOB_CNC_V_POWER_EXC                  (SACP_RET_PRIVATE_BASE + 28)
#define SACP_RET_JOB_ENCLOSURE_DOOR_OPEN              (SACP_RET_PRIVATE_BASE + 29)
#define SACP_RET_JOB_LASER_IMU_CONNECTION             (SACP_RET_PRIVATE_BASE + 30)
#define SACP_RET_JOB_LASER_TUBE_TEMP_TOO_HIGH         (SACP_RET_PRIVATE_BASE + 31)
#define SACP_RET_JOB_LASER_ABNORMAL_ATTTUDE           (SACP_RET_PRIVATE_BASE + 32)
#define SACP_RET_JOB_LASER_INVLAID_PWN_PIN            (SACP_RET_PRIVATE_BASE + 33)
#define SACP_RET_JOB_LASER_TUBE_TEMP_TOO_LOW          (SACP_RET_PRIVATE_BASE + 34)
#define SACP_RET_JOB_LASER_IMU_OVERTEMP               (SACP_RET_PRIVATE_BASE + 35)
